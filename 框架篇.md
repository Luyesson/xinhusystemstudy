...
![image-20260223235503857](C:\Users\ZiQiangXHS\AppData\Roaming\Typora\typora-user-images\image-20260223235503857.png)
...
include_once 和include 的用法，均是在本作用域内引入文件内容。即可以看作是**文件和文件的连接**。因此可以在View.php（视图代码）中看到直接使用 $d $m  $a变量。这三个变量贯穿学习始终，简记成：

![image-20260224000516808](C:\Users\ZiQiangXHS\AppData\Roaming\Typora\typora-user-images\image-20260224000516808.png)
